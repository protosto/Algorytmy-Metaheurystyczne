...
public class TwoOptSolutionGenerator extends SolutionGenerator {
    ...
    public List<Integer> solve(double[][] distanceMatrix) {
        KRandomSolutionGenerator kRandomSolutionGenerator = new KRandomSolutionGenerator(10000);
        List<Integer> pointList = kRandomSolutionGenerator.solve(distanceMatrix);
