...
public class AntColonySystemLocalSearchTests {
    public static void runTests(List<String> fileNames) throws IOException {
        String path = "C:\\Users\\123w4\\Desktop\\ACS\\";
        BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter(new File(path + "LocalSearch.csv")));
        ...
        for(int k = 0; k < 25; k++) {
            AntColonySystem antColonySystem = new AntColonySystem(20, 0.3, 0.3, 1, 0.9, 500, 1, 2, 1, true, true, false);
